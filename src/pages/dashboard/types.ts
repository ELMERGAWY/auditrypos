export type DashboardTab = 'pos' | 'orders' | 'menu' | 'delivery' | 'shifts' | 'qr' | 'waiter' | 'stats' | 'settings' | 'inventory' | 'customers' | 'suppliers' | 'expenses' | 'staff' | 'notifications' | 'financials' | 'overheads' | 'customer_accounts' | 'sales_returns' | 'supplier_accounts';
