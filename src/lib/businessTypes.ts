...
export const BUSINESS_TYPES: Record<BusinessType, BusinessTypeConfig> = {
  restaurant: {
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'purchase_invoices', 'purchase_orders', 'sales_invoices', 'sales_orders', 'crm', 'delivery', 'delivery', 'customers', 'customer_accounts', 'sales_returns', 'suppliers', 'supplier_accounts', 'shifts', 'stats', 'analytics', 'analytics', 'ai_assistant', 'financials', 'treasury', 'fixed_assets', 'expenses', 'staff', 'users', 'notifications', 'settings'],
  ...
  warehouse: {
    ...
    tabs: ['home', 'inventory', 'inventory_receipts', 'orders', 'menu', 'purchase_invoices', 'purchase_orders', 'sales_invoices', 'sales_orders', 'crm', 'delivery', 'delivery', 'customers', 'customer_accounts', 'sales_returns', 'suppliers', 'supplier_accounts', 'shifts', 'stats', 'analytics', 'ai_assistant', 'financials', 'treasury', 'fixed_assets', 'expenses', 'staff', 'users', 'notifications', 'settings'],
  },
  ...
  services: {
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'purchase_invoices', 'purchase_orders', 'sales_invoices', 'sales_orders', 'crm', 'delivery', 'customers', 'customer_accounts', 'sales_returns', 'shifts', 'stats', 'analytics', 'ai_assistant', 'financials', 'treasury', 'fixed_assets', 'expenses', 'staff', 'users', 'notifications', 'settings'],
  ...
  shipping: {
    ...
    tabs: ['home', 'pos', 'orders', 'crm', 'delivery', 'delivery', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'expenses', 'staff', 'settings']
  },
  distribution: {
    id: 'distribution',
    label: 'توزيع ومناديب',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'crm', 'delivery', 'delivery', 'customers', 'customer_accounts', 'suppliers', 'supplier_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'settings']
  },
  hospital: {
    id: 'hospital',
    label: 'مستشفى / عيادة',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'crm', 'delivery', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'staff', 'settings']
  },
  factory: {
    id: 'factory',
    label: 'مصنع / إنتاج',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'purchase_invoices', 'purchase_orders', 'sales_orders', 'crm', 'delivery', 'customers', 'customer_accounts', 'suppliers', 'supplier_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'settings']
  },
  real_estate: {
    id: 'real_estate',
    label: 'عقارات وتأجير',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'crm', 'delivery', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'expenses', 'staff', 'settings']
  },
  contracting: {
    id: 'contracting',
    ...
    tabs: ['home', 'projects', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'purchase_invoices', 'purchase_orders', 'crm', 'delivery', 'customers', 'customer_accounts', 'suppliers', 'supplier_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'manual_journal', 'fixed_assets', 'settings']
  },
  finishing: {
    id: 'finishing',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'crm', 'delivery', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'fixed_assets', 'expenses', 'staff', 'settings']
  },
  rental: {
    id: 'rental',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'crm', 'delivery', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'fixed_assets', 'expenses', 'staff', 'settings']
  },
  education: {
    id: 'education',
    label: 'مراكز تعليمية',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'crm', 'delivery', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'fixed_assets', 'staff', 'settings']
  },
  law_firm: {
    id: 'law_firm',
  ...
  marketing_agency: {
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'crm', 'delivery', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'fixed_assets', 'expenses', 'staff', 'settings']
  },
  gym: {
    id: 'gym',
    label: 'نوادي رياضية',
  ...
  auto_repair: {
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'purchase_invoices', 'crm', 'delivery', 'customers', 'customer_accounts', 'suppliers', 'supplier_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'fixed_assets', 'expenses', 'staff', 'settings']
  }
};
