...
export const BUSINESS_TYPES: Record<BusinessType, BusinessTypeConfig> = {
  ...
  services: {
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'purchase_invoices', 'purchase_orders', 'sales_invoices', 'sales_orders', 'crm', 'customers', 'customer_accounts', 'sales_returns', 'shifts', 'stats', 'analytics', 'ai_assistant', 'financials', 'treasury', 'fixed_assets', 'expenses', 'staff', 'users', 'notifications', 'settings'],
  ...
  hospital: {
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'crm', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'staff', 'settings']
  },
  factory: {
    id: 'factory',
    label: 'مصنع / إنتاج',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'purchase_invoices', 'purchase_orders', 'sales_orders', 'crm', 'customers', 'customer_accounts', 'suppliers', 'supplier_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'settings']
  },
  real_estate: {
    id: 'real_estate',
    label: 'عقارات وتأجير',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'crm', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'expenses', 'staff', 'settings']
  },
  contracting: {
    id: 'contracting',
    ...
    tabs: ['home', 'projects', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'purchase_invoices', 'purchase_orders', 'crm', 'customers', 'customer_accounts', 'suppliers', 'supplier_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'manual_journal', 'fixed_assets', 'settings']
  },
  finishing: {
    id: 'finishing',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'crm', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'fixed_assets', 'expenses', 'staff', 'settings']
  },
  rental: {
    id: 'rental',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'crm', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'fixed_assets', 'expenses', 'staff', 'settings']
  },
  education: {
    id: 'education',
    label: 'مراكز تعليمية',
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'crm', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'fixed_assets', 'staff', 'settings']
  },
  law_firm: {
    id: 'law_firm',
  ...
  marketing_agency: {
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'crm', 'customers', 'customer_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'fixed_assets', 'expenses', 'staff', 'settings']
  },
  gym: {
    id: 'gym',
    label: 'نوادي رياضية',
  ...
  auto_repair: {
    ...
    tabs: ['home', 'pos', 'orders', 'menu', 'inventory', 'inventory_receipts', 'purchase_invoices', 'crm', 'customers', 'customer_accounts', 'suppliers', 'supplier_accounts', 'stats', 'analytics', 'ai_assistant', 'financials', 'accounting', 'fixed_assets', 'expenses', 'staff', 'settings']
  }
};
