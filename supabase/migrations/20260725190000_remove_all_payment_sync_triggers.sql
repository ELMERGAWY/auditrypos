...
DO $sales_orders_payment_trigger_guard$
BEGIN
  ...
  ELSE
    RAISE NOTICE 'sales_orders is not installed; skipped optional payment trigger removal';
  END IF;
END;
$sales_orders_payment_trigger_guard$;
