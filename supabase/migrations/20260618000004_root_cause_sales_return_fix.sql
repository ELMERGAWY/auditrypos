-- ============================================================
-- COMPLETE ROOT FIX - SALES RETURN INVENTORY & CUSTOMER BALANCE + ALL ISSUES
-- ============================================================
...
BEGIN
  ...
  -- Create journal entry header - temporarily set to 0
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'customer_transactions table not found, skipping';
  END IF;
END
$$;
...
DO $$
BEGIN
  RAISE NOTICE '✅✅ COMPLETE FIX APPLIED! Sales returns now update inventory AND customer balance!';
END
$$;
